...
public class Main {
    ...
    public static void main(String[] args) throws Exception {
        System.out.println( String.valueOf(min(-20, -10)));
        System.out.println( String.valueOf(min(-40, -10, -30, 40)));
        System.out.println( String.valueOf(min(-20, -40, -30, 40)));
        System.out.println( String.valueOf(min(-20, -10, -40, 40)));
        System.out.println( String.valueOf(min(-20, -10, -30, -40)));
    }
}
